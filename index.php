...
<head>
    ...
    <meta name="keywords" content="Donut - пончики"/>
    <meta name="robots" content="all"/>
    <meta name="description" content="Donut - пончики">
    <title>Donut</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 animated slideInDown ">
                    <nav>
                        <ul >
                            <li><a class="active button button--ujarak button--border-thin button--text-thick" href="#">Главная</a></li>
                            <li><a class="button button--ujarak button--border-thin button--text-thick" href="#">Что мы делаем</a></li>
                            <li><a class="button button--ujarak button--border-thin button--text-thick" href="#">Продукты</a></li>
                            <li><a class="button button--ujarak button--border-thin button--text-thick" href="#">О Нас</a></li>
                            <li><a class="button button--ujarak button--border-thin button--text-thick" href="#">Контакты</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="header col-md-12">
                    <img class="animated flipInY" src="img/logo.png" alt=""/>
                    <h2 class="animated flipInY col-md-8 col-md-offset-2">Лучшие друзья  пончиков это - кофе</h2>
                </div>
                <div class="animated slideInUp more">
                    <a class=" scroll" href="#2"><img src="img/more.png" alt=""/></a>
                </div>
            </div>
        </div>
        <div class="bg"></div>
